...
class EnhancedCertificateService {
  ...
  static Future<File> generateCertificate({
    ...
    switch (certificateType.toLowerCase()) {
      case 'baptism':
        await _generateBaptismCertificate(
          pdf,
          recordData,
          ttfRegular,
          ttfBold,
        ...
        break;
      case 'marriage':
        await _generateMarriageCertificate(
          pdf,
          recordData,
          ttfRegular,
          ttfBold,
        ...
        break;
      case 'confirmation':
        await _generateConfirmationCertificate(
          pdf,
          recordData,
          ttfRegular,
          ttfBold,
      ...
      case 'funeral':
      case 'death':
        await _generateFuneralCertificate(
          pdf,
          recordData,
          ttfRegular,
          ttfBold,
        ...
        break;
      default:
        await _generateGenericCertificate(
          pdf,
          recordData,
          ttfRegular,
          ttfBold,
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow(
                      'Place of Baptism:',
                      data['place']?.toString() ?? 'Not specified',
                      regular,
                      bold,
                    ),
                    _buildDetailRow(
                      'Parish:',
                      data['parish']?.toString() ?? 'Not specified',
                      regular,
                      bold,
                    ),
                    ...
                    if (data['notes'] != null)
                      ..._parseBaptismNotes(data['notes'], regular, bold),
                    ...
                    pw.Container(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          _buildDetailRow(
                            'Book/Page/Line:',
                            '${data['bookNumber'] ?? 'N/A'}/${data['pageNumber'] ?? 'N/A'}/${data['lineNumber'] ?? 'N/A'}',
                            regular,
                            regular,
                          ),
                        ],
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (data['notes'] != null)
                      ..._parseMarriageNotes(data['notes'], regular, bold),
                  ],
                ),
              ),
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (data['notes'] != null)
                      ..._parseConfirmationNotes(data['notes'], regular, bold),
                  ],
                ),
              ),
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (data['notes'] != null)
                      ..._parseFuneralNotes(data['notes'], regular, bold),
                  ],
                ),
              ),
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow(
                      'Record Type:',
                      data['type']?.toString() ?? 'Not specified',
                      regular,
                      bold,
                    ),
                    _buildDetailRow(
  ...
  static List<pw.Widget> _parseBaptismNotes(
    dynamic notes,
    pw.Font regular,
    pw.Font bold,
  ) {
  ...
  static List<pw.Widget> _parseMarriageNotes(
    dynamic notes,
    pw.Font regular,
    pw.Font bold,
  ) {
  ...
  static List<pw.Widget> _parseConfirmationNotes(
    dynamic notes,
    pw.Font regular,
    pw.Font bold,
  ) {
  ...
  static List<pw.Widget> _parseFuneralNotes(
    dynamic notes,
    pw.Font regular,
    pw.Font bold,
  ) {
    ...
    try {
      if (notes is String) {
        widgets.add(pw.SizedBox(height: 10));
        widgets.add(
          _buildDetailRow('Additional Information:', notes, regular, bold),
        );
      }
    } catch (e) {
