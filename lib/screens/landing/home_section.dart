            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Icons.people_outline, color: LandingCommon.primary, size: 18),
                ),
                ...
                Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text('Community', style: LandingCommon.bodyStyle(fontSize: 11, color: Colors.grey.shade500)),
                    Text('Est. 1952', style: LandingCommon.bodyStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black87)),
                  ],
                ),
              ],
            ),
...
class _HomeCopy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleSize = w < 400 ? 34.0 : (w < 600 ? 40.0 : (w < 1000 ? 48.0 : 58.0));
    final subtitleSize = w < 400 ? 14.0 : (w < 600 ? 15.0 : (w < 1000 ? 17.0 : 19.0));
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: LandingCommon.primary.withValues(alpha: 0.2)),
          ),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.church_outlined, size: 14, color: LandingCommon.primary),
        ...
        Text(
          ...
          style: LandingCommon.titleStyle(fontSize: titleSize, color: Colors.black87).copyWith(height: 1.1),
        ),
        const SizedBox(height: 20),
        ConstrainedBox(
  ...
  Widget build(BuildContext context) {
    ...
    return OutlinedButton.icon(
      ...
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(color: LandingCommon.primary.withValues(alpha: 0.3), width: 1.5),
